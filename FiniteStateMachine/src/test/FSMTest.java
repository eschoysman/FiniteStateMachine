...
public class FSMTest {
	...
	public void shouldCreateState() throws StateMachineException{
		...
		IState<MyContext, String> s0 = sm.addStartState("s0").setActions(stateEnterAction,stateExecuteAction,stateExitAction);
		IState<MyContext, String> s1 = sm.addState("s1").setActions(stateEnterAction,stateExecuteAction,stateExitAction);
		IState<MyContext, String> s2 = sm.addState("s2").setFinal(true).setActions(stateEnterAction,stateExecuteAction,stateExitAction);
